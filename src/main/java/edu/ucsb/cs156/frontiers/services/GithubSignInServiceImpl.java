...
@Service
public class GithubSignInServiceImpl extends DefaultOAuth2UserService
  ...
  private OAuth2User attachGithubSignin(OAuth2User oAuth2User) {
    ...
    if (authentication != null) {
      ...
      throw new NotAuthenticatedWithGoogleException(
          "You must login first to link your GitHub account");
    }
  }
}
