...
public class DeleteTeamFromGithubJobTests {
  ...
  public void test_getScope_returnsCourseScope() {
    ...
    DeleteTeamFromGithubJob job = DeleteTeamFromGithubJob.builder().course(course).build();
  ...
  public void test_successfully_delete_team() throws Exception {
    ...
    assertTrue(
        jobStarted.getLog().contains("Starting delete team from GitHub job for team ID 456"));
    assertTrue(jobStarted.getLog().contains("Successfully deleted GitHub team"));
  ...
  public void test_TeamDeletionFailure() throws Exception {
    ...
    assertEquals("Failed to delete GitHub team: GitHub API error", e.getMessage());
  }
