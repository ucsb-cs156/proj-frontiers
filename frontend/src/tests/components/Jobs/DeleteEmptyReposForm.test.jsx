...
describe("DeleteEmptyReposForm tests", () => {
    ...
    test("renders correctly", () => {
        ...
        expect(screen.getByTestId("DeleteEmptyReposForm-prefix")).toBeInTheDocument();
        expect(screen.getByTestId("DeleteEmptyReposForm-submit")).toBeInTheDocument();
        expect(screen.getByText(/delete all repositories in the organization/i)).toBeInTheDocument();
    });
    ...
    test("shows error toast if prefix is empty on submit", async () => {
        ...
        await waitFor(() => expect(mockToast).toHaveBeenCalledWith("Please enter a prefix"));
    ...
    test("calls API and toasts on successful submit", async () => {
        ...
        axiosMock.onDelete("/api/repos", { params: { courseId: 17, prefix: "lab01" } }).reply(200, {
        ...
        expect(axiosMock.history.delete[0].params).toEqual({ courseId: 17, prefix: "lab01" });
        expect(mockToast).toHaveBeenCalledWith("Delete empty repos job launched for prefix: lab01");
